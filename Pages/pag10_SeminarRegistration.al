    ...
    layout
    {
        ...
        area(factboxes)
        {
            part("Seminar Details FactBox";"CSD Seminar Details FactBox")
            {
                ...
                //The SubPageLink property links a page part to the parent page. It
                //enables the page part to show the information related to the record
                //shown in the parent page
            }
